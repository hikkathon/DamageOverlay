...
namespace WpfAppDPO.Models
{
    class MemoryEditor
    {
        ...
        {
            // Damage
            Int32 dmgAddr = BA + 0x02F83B08; // 1 базовый адрес 2 смещение +7B9DC = новое смещение для БА
            ...
            // Blocked
            Int32 blckAddr = BA + 0x02F83B08; // 1 базовый адрес 2 смещение
            ...
            Int32[] HealthOffsets = { 0x24, 0x34, 0x60, 0x10, 0xF8, 0x174};
